export const translations = {
  az: {
    ...
    generate: {
      badge: "AI Veb Sayt Qurucusu",
      title: "Bu gün nə qururuq?",
      desc: "Biznesinizi təsvir edin və biz saniyələr ərzində yüksək keyfiyyətli veb sayt hazırlayacağıq.",
      form: {
        businessName: "Biznes Adı",
        businessPlaceholder: "məs. Acme Studio",
        service: "Sənaye / Xidmət",
        servicePlaceholder: "məs. İnteryer Dizayn",
        audience: "Hədəf Kütləsi & Üslub",
        audiencePlaceholder: "məs. Gənc mütəxəssisləri hədəfləyən müasir, minimalist üslub. Bahalı görünməsini istəyirik.",
        location: "Məkan",
        locationPlaceholder: "məs. Bakı, Azərbaycan",
        contact: "Əlaqə",
        contactPlaceholder: "məs. salam@acme.az",
        style: {
            title: "Vizual Üslub",
            minimal: "Minimal",
            minimalDesc: "Təmiz, geniş boşluqlar, ağ-qara",
            vibrant: "Canlı",
            vibrantDesc: "Parlaq rənglər, qradientlər, yüksək enerji",
            corporate: "Korporativ",
            corporateDesc: "Etibarlı, mavi/göy, strukturlaşdırılmış",
            dark: "Qaranlıq Rejim",
            darkDesc: "Şıq, neon vurğular, qaranlıq tema",
        },
        submit: "Veb Sayt Yarat",
        generating: "Yaradılır..."
      },
      loading: [
        "Biznes profili təhlil edilir...",
        "Dizayn strukturu hazırlanır...",
        "Tipoqrafiya & rəng palitrası seçilir...",
        "Premium görüntülər gətirilir...",
        "Mətn yazılır...",
        "Detallar cilalanır..."
      ]
    }
  ...
  en: {
    ...
    generate: {
      badge: "AI Website Builder Engine",
      title: "What are we building today?",
      desc: "Describe your dream website in detail, and we'll engineer it in seconds.",
      form: {
        promptLabel: "Describe your website",
        promptPlaceholder: "e.g. A modern landing page for a coffee shop called 'Brew & Bean'. It should have a dark aesthetic, a menu section, and a contact form.",
        style: {
            title: "Visual Style",
            minimal: "Minimal",
            minimalDesc: "Clean, whitespace-heavy, black & white",
            vibrant: "Vibrant",
            vibrantDesc: "Bold colors, gradients, high energy",
            corporate: "Corporate",
            corporateDesc: "Trustworthy, blue/navy, structured",
            dark: "Dark Mode",
            darkDesc: "Sleek, neon accents, dark theme",
        },
